                                ...
                                text-slate-700 mb-2'>
                                 ...
                                 <div className='grid grid-cols-2 gap-4'>
                                            <div>
                                               ...
                                               <input type="date" name='start date' required min={minDate} />
                                            </div>
                                            <div>
                                               <span className='block text-xs text-slate-400 mb-1'>
                                                To
                                               </span>
                                               <input type="date" name='end date' required min={minDate} />
                                            </div>
                                 </div>
                                </div>
                                   {/**-------Reason----------- */}
                                    <div>
                                    <label className='ftext-sm font-medium text-teal-700 mb-2 block'>
                                         <FileText className='w-4 h-4
                                          text-slate-400'/>Reason
                                 </label>   
