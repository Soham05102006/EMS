           ...
           <div className='space-y-5'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <textarea disabled={initialData.isDeleted} 
                            defaultValue={initialData.bio || " "} name="bio"
                            placeholder='Write a brief Bio...'
                            className={`resize-none
                             ${initialData.isDeleted ? "bg-slate-50 text-slate-400 cursor-not-allowed" : " "}`} />
                             <p className='text-slate-400 mt-1.5 text-xs'>This will be displayed on your profile.</p>
                        ...
                        {initialData.isDeleted ?(
                              <div className='pt-2'>
                                        ...
                                        rounded-xl text-center'>
                                            <p className='text-rose-600 font-medium tracking-tight'>Account Deactivatec</p>
                                            <p>You can no longer update your Profile.</p>
                                        </div>
                              </div>
                        ) : ( <div className='flex justify-end pt-2'>
                                      <button type='submit' disabled={loading}
                                      className='btn-primary inline-flex items-center gap-2 justify-center px-4 py-2 text-sm'>
