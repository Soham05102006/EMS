     ...
     {/** --------------------Header------------------------------ */}
         ...
         <div className="flex flex-col sm:flex-row gap-3 mb-4">
              <div className="relative flex-1">
                  <Search size={16} className="absolute left-3.5 top-1/2 transform
         ...
         {/** ---------------Employees card -------------- */}
          {loading ? (
            <div className="flex justify-center p-12">
                 <div className="animate-spin h-8 w-8 border-2 border-indigo-800 border-t-transparent rounded-full">
                    <Loading />
                 </div>
            </div>
          ) : (
            ...
            {/** Create Employee Modal  */}
                 {showcreateModal && (
                     ...
                     items-start justify-center p-4 overflow-y-auto' onClick={
                  ...
                  max-w-3xl my-8 animate-fade-in' onClick={(e)=>e.stopPropagation()}>
                   <div className='flex items-center justify-between p-6 pb-0'>
                              ...
                              <div>
                                  ...
                                  <p className='text-sm text-slate-500 mt-0.5'>Update Employee Deatils</p>
                              </div>
